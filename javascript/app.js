...
const whatsappLinkGenerator = (phoneNumber, productTitle, productQuantity, buyerName, buyerAddress, buyerPayment) => `https://api.whatsapp.com/send?phone=${phoneNumber}&text=Olá, eu quero: ${productQuantity} 
${productTitle} - Entregar para ${buyerName} no endereço: ${buyerAddress} - A forma de pagamento será: ${buyerPayment}`
